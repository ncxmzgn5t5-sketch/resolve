export const leaders = [
  {
    ...
    fullBio:
      "Azril is a strategy and operations professional with over 10 years of experience leading digital transformation, target operating model development, business optimisation, and complex programme delivery. He has worked across cross-functional environments where clarity, pace, and stakeholder alignment are critical to successful execution.",
    specialisations: [
      "Digital transformation",
      "Strategy and implementation",
      "Programme and project management",
      "Post-merger process optimisation",
      "Core systems replacement and integration",
    ],
